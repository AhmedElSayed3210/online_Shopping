...
<html lang="en">
    <head>
        ...
        <%
            ...
            query db = new query();
            set = db.search(Integer.parseInt(search), sortcondition, key);
            if (search.equals("0")) {
                product_type = "All";
                ...
                <div id="logoArea" class="navbar">
                    ...
                    <div class="navbar-inner">
                        ...
                        <form class="form-inline navbar-search" method="post" action="search.jsp" >
                            <input id="srchFld" class="srchTxt" type="text" name="key" value="<%=key%>" style="padding-left: 30px"/>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="span9">
                        ...
                        <hr class="soft"/>
                        <form class="form-horizontal span6" action="search.jsp" method="post">
                            <div class="control-group">
                        ...
                        <div class="tab-content">
                                ...
                                <div class="row">	  
                                    ...
                                    <div class="span3 alignR">
                                        <form class="form-horizontal qtyFrm">
                                            ...
                                            <br/>
                                            <div class="btn-group">
                                                <a href="javascript:" class="btn btn-large btn-primary"> Add to <i class=" icon-shopping-cart"></i></a>
                            ...
                            <div class="tab-pane  active" id="blockView">
                                <%
                                    ResultSet rset = db.search(Integer.parseInt(search), sortcondition, key);
                                %>
                                <ul class="thumbnails">
                                    <%while (rset.next()) {%>
                                    <li class="span3">
