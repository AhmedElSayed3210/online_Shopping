                        ...
                        <form class="form-horizontal" action="contact" method="post" >
                            <fieldset>
                                ...
                                <div class="control-group">
                                    ...
                                    <input type="text" placeholder="name" class="input-xlarge" value="<%=u.getFname() + " " + u.getLname()%>" required="required" name="name"/>

                                </div>
                                <div class="control-group">

                                    <input type="text" placeholder="email" class="input-xlarge" value="<%=u.getEmail()%>" required="required" name="email"/>

                                </div>
                                <%} else {%>
                                <div class="control-group">

                                    <input type="text" placeholder="name" class="input-xlarge" name="name" value="" required="required"/>

                                </div>
                                <div class="control-group">

                                    <input type="text" placeholder="email" class="input-xlarge" name="email" value="" required="required"/>

                                </div>
                                <%}%>
                                <div class="control-group">

                                    <input type="text" placeholder="subject" class="input-xlarge" name="subject" value="" required="required"/>

                                </div>
                                <div class="control-group">
                                    <textarea rows="3" id="textarea" class="input-xlarge" name="problem" required="required" ></textarea>
