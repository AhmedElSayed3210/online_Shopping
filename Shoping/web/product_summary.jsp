            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="span9">
                        ...
                        <h3>  SHOPPING CART [ <small><%=item%> Item(s) </small>]<a href="products.jsp" class="btn btn-large pull-right"><i class="icon-arrow-left"></i> Continue Shopping </a></h3>	
                        <hr class="soft"/>
                        ...
                        <table class="table table-bordered" >
                            ...
                            <tbody>
                                ...
                                %>
                                <tr>
                                    <td style="text-align: center"> <img width="60" src="images/<%=car.get(i).getNimage()%>" alt=""/></td>
                                    <td><%=car.get(i).getName()%><br/>Model :<%=car.get(i).getModel()%> </td>
                                    <td><%=car.get(i).getPrice()%></td>
                                    <td><%=car.get(i).getQuantity()%></td>
                                    <td><%=(car.get(i).getPrice()) * (car.get(i).getQuantity())%></td>
                                    <td>
                                        <form action="product_summary_operation" method="post">
                                            <input type="hidden" name="id" value="<%=i%>"/>
                                            <input type="hidden" name="product_id" value="<%=car.get(i).getId()%>"/>
                                            <input type="hidden" name="items" value="<%=car.get(i).getQuantity()%>"/>
                                            <input type="hidden" name="total" value="<%=car.get(i).getTotal_quantity()%>"/>
                                            <button class="btn btn-danger" type="submit" style="width: 50px"><i class="icon-remove icon-white"></i></button>
                                        </form>
                                    </td>
                                </tr>
                                <%}%>
                                ...
                                <tr>
                                    <td colspan="6" style="text-align:right"><strong>TOTAL ($<%=total_price%>+ $30) =</strong></td>
                                    <td class="label label-important" style="display:block"> <strong> $<%=(total_price + 30)%> </strong></td>
                                </tr>

                            </tbody>
                        </table>
                        <a href="products.jsp" class="btn btn-large"><i class="icon-arrow-left"></i> Continue Shopping </a>
                        <a href="finaly_cart" class="btn btn-large pull-right">Ok <i class="icon-arrow-right"></i></a>
