                        ...
                        <div class="row">
                            <div class="span9" style="min-height:900px">
                                <div class="well">
                                    ...
                                    Please enter the email address for your account. A verification code will be sent to you. Once you have received the verification code, you will be able to choose a new password for your account.<br/>
                                    ...
                                    <br> 2- Disable avast for 10 minutes.<br/>
                                    <form action="forgetpass" method="post">
                                        <div class="control-group">
                                            <label class="control-label" for="inputEmail1">E-mail address</label>
                                            <div class="controls">
                                                <input class="span3"  type="text" id="inputEmail1" placeholder="Email" required="required" name="email" value="">
                                            </div>
                                        </div>
                                        <div class="controls">
